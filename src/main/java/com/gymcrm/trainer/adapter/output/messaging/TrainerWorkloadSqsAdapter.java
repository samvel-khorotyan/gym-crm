...
public class TrainerWorkloadSqsAdapter
    ...
    public void sendTrainerWorkload(Training training, ActionType actionType) {
        ...
        log.info("Transaction ID: {} - Sending trainer workload message for trainer: {}, action: {}",
    ...
    public TrainerMonthlyWorkloadResponse getTrainerMonthlyWorkload(String username, int year, int month) {
        ...
        log.info("Transaction ID: {} - Getting monthly workload for trainer: {}, year: {}, month: {}",
        ...
        try {
            ...
            log.info("Transaction ID: {} - Successfully received monthly workload for trainer: {}, summary duration: {}",
    ...
    public void handleWorkloadResponse(TrainerWorkloadResponseMessage response) {
        ...
        if (future != null) {
            ...
            log.warn("Transaction ID: {} - Received response for unknown transaction ID: {}",
    ...
    private void sendTrainerWorkloadFallback(Training training, ActionType actionType, Exception e) {
        ...
        log.warn("Transaction ID: {} - Circuit breaker activated for sendTrainerWorkload. Error: {}",
                transactionId, e.getMessage());
    }

    private TrainerMonthlyWorkloadResponse getTrainerMonthlyWorkloadFallback(String username, int year, int month, Exception e) {
        String transactionId = MDC.get("transactionId");
        log.warn("Transaction ID: {} - Circuit breaker activated for getTrainerMonthlyWorkload. Error: {}",
                transactionId, e.getMessage());

        return TrainerMonthlyWorkloadResponse.builder()
                .username(username)
                .firstName("N/A")
                .lastName("N/A")
                .isActive(true)
    ...
    private void sendMessage(TrainerWorkloadMessage message, String transactionId) {
        ...
        try {
            ...
            log.error("Transaction ID: {} - Failed to send trainer workload message: {}",
    ...
    private void sendGetWorkloadRequest(String username, int year, int month, String transactionId) {
        TrainerWorkloadMessage message = TrainerWorkloadMessage.builder()
                .username(username)
                .year(year)
                .month(month)
    ...
    private void handleWorkloadRequestException(Exception e, String transactionId) {
        ...
        if (e instanceof TimeoutException) {
            ...
            log.error("Transaction ID: {} - Error getting trainer monthly workload: {}",
                    transactionId, e.getMessage(), e);
        }
    }
    ...
    private TrainerMonthlyWorkloadResponse mapToWorkloadResponse(TrainerWorkloadResponseMessage response) {
        return TrainerMonthlyWorkloadResponse.builder()
                ...
                .summaryDuration(response.getSummaryDuration())
                .build();
    }
}
