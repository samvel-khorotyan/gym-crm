...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<ErrorsDetails> handleNotFoundException(
  ...
  protected ResponseEntity<ErrorsDetails> handleUnauthorizedException(
      Throwable ex, WebRequest request) {
    ErrorsDetails errorDetails = new ErrorsDetails(ex.getMessage());
  ...
  protected ResponseEntity<ErrorsDetails> handleForbiddenException(
      Throwable ex, WebRequest request) {
    ErrorsDetails errorDetails = new ErrorsDetails(ex.getMessage());
  ...
  protected ResponseEntity<ErrorsDetails> handleBadRequestException(
      Throwable ex, WebRequest request) {
    ErrorsDetails errorDetails = new ErrorsDetails(ex.getMessage());
  ...
  protected ResponseEntity<ErrorsDetails> handleConflictException(
      Throwable ex, WebRequest request) {
    ErrorsDetails errorDetails = new ErrorsDetails(ex.getMessage());
